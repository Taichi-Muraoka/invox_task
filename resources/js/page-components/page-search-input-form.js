...
import PageSearchListInput from "./page-search-list-input";

/**
 * ページコンポーネント: 検索フォーム + input
 */
export default class PageSearchInputForm extends PageComponentBase {
    /*
     * Vueインスタンスを取得
     */
    getVueApp(option = {}) {
        ...
        const vueApp = {
            ...
            mounted() {
                ...
                this.vueSearchList = pageSearchlistInput.getVueApp(
